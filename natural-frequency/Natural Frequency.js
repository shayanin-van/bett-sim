...
function DrawValue() {
    // label / value / slider columns share one grid: see style.css for the slider positions
    contextTop.textAlign = 'center';
    contextTop.font = "30px Arial";
    contextTop.fillStyle = '#0071BC';
    contextTop.fillText(NatFreq.toFixed(2) + " Hz", 500, 644);

    contextTop.font = "16px Arial";
    contextTop.fillStyle = '#000000';
    contextTop.fillText("Natural frequency", 500, 608);

    contextTop.textAlign = 'right';
    contextTop.fillText(parseFloat(WindFrequencySlider.value).toFixed(2) + " Hz", 959, 448);

    contextTop.textAlign = 'left';
    contextTop.fillText("Wind :", 830, 448);
    contextTop.fillText("k :", 48, 608);
    contextTop.fillText(SpringStiffnessSlider.value + " N/m", 90, 608);
    contextTop.fillText("m :", 48, 645);
    contextTop.fillText(parseFloat(MassSlider.value).toFixed(1) + " kg", 90, 645);
}
...
function convToCanvasX(WinX) {
    ...
    return (WinX - rect.left)*canvas.width/rect.width;
}